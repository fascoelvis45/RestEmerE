                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <%
                            ...
                            SQL = "SELECT *   FROM pedido "
                                    + " where  id_usuario = '" + id_usuario + "' and estado ='1'  AND  DATE_FORMAT(fecha,'%m-%d-%Y') = DATE_FORMAT(NOW(),'%m-%d-%Y')  ";
                        ...
                        <tr>
                            ...
                            <td> 
                                <button class="btn btn-success btn-sm"  onclick="cargarURL('pedido/formEditPedido.jsp?id_pedido=<%=rs.getObject("id")%>', 'content')">
